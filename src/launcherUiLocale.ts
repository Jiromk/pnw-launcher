...
export function getLauncherUi(L: UiLang) {
  const fr = {
    ...
    battleTower: {
      nav: { home: "Accueil", lead: "Combat Classé", amical: "Combat Amical", profile: "Profil", players: "Joueurs" },
      ...
      lead: {
        ...
        leaderboardHint: "Termine tes 5 placements pour apparaître ici",
        leaderboardLoading: "Chargement du classement...",
        leaderboardFilters: {
          global: "Global",
          apex: "Apex",
        },
        leaderboardYouNotRanked: "Tu n'es pas encore classé",
        leaderboardYouRank: (rank: number, total: number) =>
          `Ta position : #${rank} sur ${total}`,
        footer:
        ...
        info: {
          buttonAria: "Comment fonctionne le classé",
          title: "Système classé",
          subtitle: "MMR · LP · Rangs · Matchmaking",
          howTitle: "Comment ça marche",
          howMmr: {
            label: "MMR (caché)",
            desc: "Ton vrai niveau. Utilisé par le serveur pour te trouver un adversaire de ta force.",
          },
          howLp: {
            label: "LP (visible)",
            desc: "0 → 100 dans chaque rang. Tu en gagnes en gagnant, tu en perds en perdant.",
          },
          howRank: {
            label: "Rang",
            desc: "10 paliers de Fer à Challenger. Tu changes de rang à 100 LP (montée) ou 0 LP + défaite (descente).",
          },
          tiersTitle: "Les 10 rangs",
          tiersHint: "Du débutant au sommet absolu",
          placementTitle: "Phase de placement",
          placementBody: [
            "Tes 5 premiers matchs n'affichent pas de LP.",
            "Le serveur calibre ton MMR plus vite (k=40 au lieu de 24).",
            "Ton rang initial est attribué selon ton MMR final.",
          ],
          progressTitle: "Promotion & démotion",
          progressBody: [
            "100 LP + victoire → tier suivant (avec 10 LP de bonus dans le nouveau).",
            "0 LP + défaite → tier précédent (avec 75 LP de coussin pour rebondir).",
            "Tu ne peux pas tomber sous Fer.",
          ],
          mmrWindowTitle: "Matchmaking",
          mmrWindowBody: [
            "0–30 s : ±150 MMR",
            "30–90 s : ±300 MMR",
            "90 s–3 min : ±600 MMR",
            "3 min+ : n'importe quel adversaire en queue",
          ],
          apexTitle: "Apex (Maître / GM / Challenger)",
          apexBody:
            "À partir de Maître, le LP n'a plus de plafond et le rang dépend uniquement de ton MMR. Pour les meilleurs joueurs.",
          banlistTitle: "Pokémons bannis",
          banlistScope: "Restriction applicable uniquement en Combat Classé",
      ...
      players: {
        ...
        subtitle: "Tous les dresseurs enregistrés sur le launcher.",
        tabs: { all: "Tous", online: "En ligne", friends: "Amis" },
        searchPlaceholder: "Rechercher un joueur…",
        count: (n: number) => `${n} joueur${n > 1 ? "s" : ""}`,
        showAll: (n: number) => `Voir tout (${n})`,
        showLess: "Réduire",
  ...
  const en = {
    ...
    battleTower: {
      nav: { home: "Home", lead: "Ranked Combat", amical: "Friendly Combat", profile: "Profile", players: "Players" },
      ...
      lead: {
        ...
        leaderboardEmpty: "No ranked players yet",
        leaderboardHint: "Finish your 5 placements to appear here",
        leaderboardLoading: "Loading leaderboard...",
        leaderboardFilters: {
          global: "Global",
          apex: "Apex",
        },
        leaderboardYouNotRanked: "You're not ranked yet",
        leaderboardYouRank: (rank: number, total: number) =>
        ...
        info: {
          buttonAria: "How ranked works",
          title: "Ranked system",
          subtitle: "MMR · LP · Tiers · Matchmaking",
          howTitle: "How it works",
          howMmr: {
            label: "MMR (hidden)",
            desc: "Your true skill rating. Used by the server to find an opponent at your level.",
          },
          howLp: {
            label: "LP (visible)",
            desc: "0 → 100 within each tier. Earned on wins, lost on losses.",
          },
          howRank: {
            label: "Rank",
            desc: "10 tiers from Iron to Challenger. You move up at 100 LP (win) or down at 0 LP (loss).",
          },
          tiersTitle: "The 10 ranks",
          tiersHint: "From beginner to the absolute peak",
          placementTitle: "Placement phase",
          placementBody: [
            "Your first 5 matches don't show LP.",
            "The server calibrates your MMR faster (k=40 instead of 24).",
            "Your initial rank is assigned based on your final MMR.",
          ],
          progressTitle: "Promotion & demotion",
          progressBody: [
            "100 LP + win → next tier (with a 10 LP bonus in the new tier).",
            "0 LP + loss → previous tier (with a 75 LP cushion to bounce back).",
            "You can't fall below Iron.",
          ],
          mmrWindowTitle: "Matchmaking",
          mmrWindowBody: [
            "0–30 s: ±150 MMR",
            "30–90 s: ±300 MMR",
            "90 s–3 min: ±600 MMR",
            "3 min+: any opponent in the queue",
          ],
          apexTitle: "Apex (Master / GM / Challenger)",
          apexBody:
            "From Master onward, LP has no cap and your tier depends solely on your MMR. For the very best players.",
          banlistTitle: "Banned Pokémon",
          banlistScope: "Restriction applies only to Ranked Combat",
      ...
      players: {
        title: "Player List",
        subtitle: "All trainers registered on the launcher.",
        tabs: { all: "All", online: "Online", friends: "Friends" },
        searchPlaceholder: "Search a player…",
        count: (n: number) => `${n} player${n > 1 ? "s" : ""}`,
        showAll: (n: number) => `Show all (${n})`,
        showLess: "Show less",
        empty: "No matching player.",
        unranked: "Unranked",
        noStats: "—",
        status: {
          available: "Available",
